...
Public Class crSamplesAllocations
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InventoryDashboard2014.crSamplesAllocations.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSamplesAllocations
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSamplesAllocations = New crSamplesAllocations()
        rpt.Site = Me.Site
        Return rpt
    End Function
