...
Public Class frmItem
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim MOQ As New SqlParameter("@MOQ", SqlDbType.VarChar, 25) : MOQ.Direction = ParameterDirection.Input : MOQ.Value = txtMOQ.Text : Params(4) = MOQ
            Dim Shelflife As New SqlParameter("@Shelflife", SqlDbType.VarChar, 25) : Shelflife.Direction = ParameterDirection.Input : Shelflife.Value = txtShelflife.Text : Params(4) = Shelflife
            If ItemExists() Then
